...
<script>
    export default {
        ...
        methods: {
            load() {
                fetch("http://localhost/tAddress/page?pageNum=" + this.pageNum + "&pageSize=" + this.pageSize).then(res => res.json().then(res => {
                    console.log(res);
            ...
            toSearch() {
                fetch("http://localhost/tAddress/searchPage?pageNum=" + this.pageNum + "&pageSize=" + this.pageSize + "&searchKey=" + this.searchKey)
            ...
            toAddGoodsType() {
                this.$router.push('/main/addressAdd')
            },
            handleEdit(row) {
                this.$router.push('/main/addressUpdate?id=' + row.aid)
            },
            handleDelete(row) {
                let _this = this;
                this.$confirm('此操作将永久删除' + row.title + '商品信息, 是否继续?', '提示', {
                    ...
                    axios.delete('http://localhost/tAddress/delete/' + row.aid).then(function (resp) {
                        if (resp) {
